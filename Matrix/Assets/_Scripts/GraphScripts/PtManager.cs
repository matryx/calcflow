...
public class PtManager : MonoBehaviour
{
    ...
    void Update()
    {
        Debug.Log("ttttttttttttttttttttoooooooooooooooooommmmmmmmmmmmmmmmmmmmmmm ptSet.ptCoords[pt1]: " + new Vector3(ptSet.ptCoords["pt1"].X.Value, ptSet.ptCoords["pt1"].Y.Value, ptSet.ptCoords["pt1"].Z.Value) );
