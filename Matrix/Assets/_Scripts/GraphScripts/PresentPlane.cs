...
public class PresentPlane : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //ptManager.ptSet.ptCoords["pt1"].X.Value = 5;
        //ptManager.ptSet.ptCoords["pt1"].X.Value = 5;
        //Debug.Log("ttttttttttttttttttttooooooooooo pt Manager.ptSet.ptCoords[pt1].X.Value: " + ptManager.ptSet.ptCoords["pt1"].X.Value);
