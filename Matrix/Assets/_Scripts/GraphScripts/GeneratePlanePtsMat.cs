...
public class GeneratePlanePtsMat : MonoBehaviour
{
    ...
    public PresentPlaneMatrix presentPlaneMatrix;
    ...
    void Awake()
    {
        if (ptManagerMat != null && ptManagerMat.eqnSet != null)
        {
            ptSetExist = true;
            eqnSet = ptManagerMat.eqnSet;
        }
    }

    void Update()
    {
        if (!ptSetExist && ptManagerMat != null && ptManagerMat.eqnSet != null)
        {
            ptSetExist = true;
            eqnSet = ptManagerMat.eqnSet;
        }
    ...
    public void eqnToPoints()
    {
        ...
        ptManagerMat.eqnUpdatePoint(pt1, pt2, pt3);
    }
    ...
    public void getCenter()
    {
        ...
        presentPlaneMatrix.center = center;
    }
