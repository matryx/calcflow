...
public class OrthPtOutputMenu : MonoBehaviour
{

    internal class KeyboardInputResponder : FlexMenu.FlexMenuResponder
    {
        OrthPtOutputMenu ptoutputMenu;
        internal KeyboardInputResponder(OrthPtOutputMenu ptoutputMenu)
        {
