...
public class PresentPlaneMatrix : MonoBehaviour
{
    ...
    public PtManagerMat ptManagerMat;
    ...
    void Awake()
    {
        ...
        if (ptManagerMat != null && ptManagerMat.ptSet != null)
        {
            ptSetExist = true;
            rawPt1 = ptManagerMat.ptSet.ptCoords["pt1"];
            rawPt2 = ptManagerMat.ptSet.ptCoords["pt2"];
            rawPt3 = ptManagerMat.ptSet.ptCoords["pt3"];
        }
    ...
    void Update()
    {
        if (!ptSetExist && ptManagerMat != null && ptManagerMat.ptSet != null)
        {
            ptSetExist = true;
            rawPt1 = ptManagerMat.ptSet.ptCoords["pt1"];
            rawPt2 = ptManagerMat.ptSet.ptCoords["pt2"];
    ...
    public bool CalculatePlane()
    {
        ...
        if (PlaneValid())
        {
            ...
            ptManagerMat.updateEqn(normalVector.x, normalVector.y, normalVector.z, d);
            return true;
        }
        else
        {
