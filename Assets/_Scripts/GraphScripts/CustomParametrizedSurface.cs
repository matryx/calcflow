...
public class CustomParametrizedSurface : ManualSerializeBehavior
{
    ...
    [RuntimeSerializeField]
    string particleTextureLoc = "Textures/particle";
    [RuntimeSerializeField]
    string particleShaderLoc = "Shaders/ParticleBillboard";
    [RuntimeSerializeField]
    string computeShaderLoc = "Compute Shaders/ParticleAnimations";
