...
namespace orthProj
{
    public class PtManager : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            updatePoint("pt1", new Vector3(0, 0, 9), false); // origin
            updatePoint("pt2", new Vector3(0, 9, 0), false); // first axis
            updatePoint("pt3", new Vector3(9, 0, 0), false); //pt to create a vector from
        }
