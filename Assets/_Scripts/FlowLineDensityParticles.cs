...
public class FlowLineDensityParticles : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((currLocalPos != referencePoint.lastLocalPos
            || currExpX != densityPlot.expressionX
            || currExpY != densityPlot.expressionY
            || currExpZ != densityPlot.expressionZ)
    ...
    void SamplePoints()
    {
        ...
        //    expXs[i] = solvers[i].SymbolicateExpression(densityPlot.es.expressions[ExpressionSet.ExpOptions.X].expression);
        //    expYs[i] = solvers[i].SymbolicateExpression(densityPlot.es.expressions[ExpressionSet.ExpOptions.Y].expression);
        //    expZs[i] = solvers[i].SymbolicateExpression(densityPlot.es.expressions[ExpressionSet.ExpOptions.Z].expression);
        //}
