...
namespace VoxelBusters.RuntimeSerialization.Internal
{
    public partial class UnityObjectSerializationUtil
    {
        ...
        private static HashSet<Component> deserializedComponents = new HashSet<Component>();
        ...
        public static Component GetComponent(UIDSystem _uidSystem, string _componentUID, Type _componentType)
        {
            ...
            if (_componentType == typeof(Transform) || _componentType == typeof(RectTransform))
            {
                ...
                if (!deserializedComponents.Contains(_newComponent)) deserializedComponents.Add(_newComponent);
            }
            else
            {
